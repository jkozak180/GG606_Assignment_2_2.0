...
```{r New data frames Q1, include=TRUE}
...
```{r New data frames Q1 cnt, include=TRUE}
...
**MASTER'S SECTION**
```{r New data frames Q1.5, include=TRUE}
#We can use the long education vector lists to find vectors that are best suited to our conditions. However, we still need to grab the affiliated shape files, which I did not do when pulling the CSD or DA data... whomp whomp. 
...
```{r New data frames Q1.5 cnt, include=TRUE}
#2001 only has one category... so no need for lots of maths
...
**PhD SECTION**
```{r New data frames Q2, include=TRUE}
#We can use the long education vector lists to find vectors that are best suited to our conditions. However, we still need to grab the affiliated shape files, which I did not do when pulling the CSD or DA data... whomp whomp. 
...
```{r New data frames Q2 cnt, include=TRUE}
#2001 only has one category... so no need for lots of maths
#This year has its data sorted by 'bachelor degree or higher' so we keep it the same.
...
```{r Prop. Change 1 BSc, include=TRUE}
...
```{r Prop. Change 2 MSc, include=TRUE}
...
```{r Prop. Change 3 PhD, include=TRUE}
...
```{r Q2 Prop. Combine, include=TRUE}
...
```{r Proportion CA01-CA21 Figure 1, include=FALSE}
...
```{r Proportion CA01-CA21 Figure 2, include=FALSE}
...
```{r Proportion CA01-CA21 Figure 3, include=TRUE}
...
```{r Q1 CA01 Figure A, include=TRUE}
...
```{r Q1 CA06 Figure A, include=TRUE}
...
```{r Q1 CA11 Figure A, include=TRUE}
...
```{r Q1 CA16 Figure A, include=TRUE}
...
```{r Q1 CA21 Figure A, include=TRUE}
...
```{r Q1.5 CA01 Figure A, include=TRUE}
...
```{r Q1.5 CA06 Figure A, include=TRUE}
...
```{r Q1.5 CA11 Figure A, include=TRUE}
...
```{r Q1.5 CA16 Figure A, include=TRUE}
...
```{r Q1.5 CA21 Figure A, include=TRUE}
#`region_name` changes here from the actual alphabetic name to numeric codes...
...
```{r Q2 CA01 Figure A, include=TRUE}
...
```{r Q2 CA06 Figure A, include=TRUE}
...
```{r Q2 CA11 Figure A, include=TRUE}
...
```{r Q2 CA16 Figure A, include=TRUE}
...
```{r Q2 CA21 Figure A, include=TRUE}
#`region_name` changes here from the actual alphabetic name to numeric codes...
